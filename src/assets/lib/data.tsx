...
import psql from '../icons/psql.svg'
...
export const skillsDataDesign = [
  {
    skillsTitle: "DevOps",
    skills: [
      { title: "Docker", hash: "#Docker", icon: docker, color: "#F24E1E" },
      {
        title: "Kubernetes",
        hash: "#Kubernates",
        icon: kuber,
      ...
      { title: "Git", hash: "#Git", icon: git, color: "#00C4CC" },
    ],
  },
] as const;
...
export const sideBarLeftSocials = [
  {
    link: "https://www.linkedin.com/in/suhail-subair/",
    icon: FiLinkedin,
    altimgname: "linkedin",
  },
  {
    link: "https://github.com/Suhailsubair007",
    icon: FiGithub,
    altimgname: "github",
  },
  {
